 ...
 * @author Proyector
 */
public class FramePolo extends javax.swing.JFrame {
    ...
    public FramePolo() {
      ...
      public FramePolo(FrameRegistro padre) {
        initComponents();
        this.padre = padre;
     ...
     //sobrecargar el costructor
       public FramePolo(FrameRegistro padre, Polo polos) {
        initComponents();
        this.padre = padre;
        this.polosSelec= polos;
        txtcolor.setText(this.polosSelec.getColor());
        txtprecio.setText(this.polosSelec.getPrecio());
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        polosSelec.setColor(txtcolor.getText());
        polosSelec.setPrecio(txtprecio.getText());

        // Llama a un método en FrameEstudiantes para actualizar el modelo del JList.
        this.padre.actualizarPolo(polosSelec);
    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FramePolo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
